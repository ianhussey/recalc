...
res <- independent_t_test_summary(
  ...
  # optionally specify the rounding mode for reported values: one of
  #   "either" (default; half-up or bankers), "half_up", "bankers", "truncate"
  rounding = "either",
  d_digits = 2, # decimal precision of the reported SMD
