...
inputs <- data.frame(
  Parameter = c(
    "M1", "M2", "SD1", "SD2", "N1", "N2",
    "m_digits", "sd_digits",
    "p_operator", "Reported p", "p_digits", "p_methods", "alternative", "alpha",
  ...
  Value = c(
    ...
    params$p_operator, params$p, params$p_digits, params$p_methods,
    if (is.null(params$alternative)) "two.sided" else as.character(params$alternative),
    params$alpha,
    params$d, params$d_ci_lower, params$d_ci_upper,
    params$direction,
    if (is.null(params$rounding)) "either" else as.character(params$rounding),
    params$d_digits,
...
```{r}
res <- recalc::recalc_independent_t(
  m1 = params$m1,
  m2 = params$m2,
  sd1 = params$sd1,
  sd2 = params$sd2,
  ...
  alternative = if (is.null(params$alternative)) "two.sided" else params$alternative,
  alpha = params$alpha,
  ...
  rounding = if (is.null(params$rounding)) "either" else params$rounding,
